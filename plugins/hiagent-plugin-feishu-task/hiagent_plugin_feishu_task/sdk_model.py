...
InputTaskModel = convert_type(task_v2.InputTask) # type: ignore
CreateTaskResponseModel = convert_type(task_v2.CreateTaskResponseBody) # type: ignore
PatchTaskResponseModel = convert_type(task_v2.PatchTaskResponseBody) # type: ignore
MemberModel = convert_type(task_v2.Member) # type: ignore
AddMembersTaskResponseModel = convert_type(task_v2.AddMembersTaskResponseBody) # type: ignore
