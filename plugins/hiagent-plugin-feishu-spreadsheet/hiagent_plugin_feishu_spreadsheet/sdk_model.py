...
from lark_oapi.api.sheets.v3 import * # type: ignore
...
CreateSpreadsheetResponseBodyModel = convert_type(CreateSpreadsheetResponseBody) # type: ignore
GetSpreadsheetResponseBodyModel = convert_type(GetSpreadsheetResponseBody) # type: ignore
QuerySpreadsheetSheetResponseBodyModel = convert_type(QuerySpreadsheetSheetResponseBody) # type: ignore
GetSpreadsheetSheetResponseBodyModel = convert_type(GetSpreadsheetSheetResponseBody) # type: ignore
