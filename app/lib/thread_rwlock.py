# -*- coding: utf-8 -*-
""" rwlock.py
    ref: https://gist.github.com/tylerneylon/a7ff6017b7a1f9a506cf75aa23eacfd6
...
class AsyncRWLock(RWLock):
    async def r_acquire(self):
        await asyncio.to_thread(self.r_acquire)

    async def r_release(self):
        await asyncio.to_thread(self.r_release)

    async def w_acquire(self):
        await asyncio.to_thread(self.w_acquire)

    async def w_release(self):
        await asyncio.to_thread(self.w_release)
